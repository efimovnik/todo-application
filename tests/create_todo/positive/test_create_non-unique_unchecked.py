...
@allure.title(
    "Creation of a non-unique unchecked item"
)
@allure.description(
    "Precondition: Count total items before test, create item with 'Un-completed item' name\n"
...
def test_create_nonunique_unchecked(set_up, name):
